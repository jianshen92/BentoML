...
class TextStream(IODescriptor[Generator[str, None, None]], descriptor_id="bentoml.io.TextStream"):
    """
    ...
    async def to_http_response(self, obj: ContentStream, ctx: Context | None = None) -> StreamingResponse:
        print("--TextStream.to_http_response--")
        print(obj)
        print(obj.__name__)
        if ctx is not None:
